** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name					paper02_04metrics.do
    //  project:				        
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\paper02_04metrics", replace
** HEADER -----------------------------------------------------

** JH time series COVD-19 data 
** RUN covidprofiles_002_jhopkins.do BEFORE this algorithm
use "`datapath'\version02\2-working\paper02_covid", clear
...
save "`datapath'\version02\2-working\paper02_covid_metrics", replace
