...
**  DO-FILE METADATA
   ...
   local parent "X:\The University of the West Indies\CaribData - Documents\COVID19Surveillance\PDF_Briefings\01 country_summaries"
    **local parent "X:\The UWI - Cave Hill Campus\CaribData - Documents\COVID19Surveillance\PDF_Briefings\01 country_summaries" // SW to use this filepath
    ...
    **local syncpath "X:\The UWI - Cave Hill Campus\CaribData - Documents\COVID19Surveillance\PDF_Briefings\01 country_summaries\\`today'" // SW to use this syncpath
** HEADER -----------------------------------------------------
