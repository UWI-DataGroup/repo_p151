...
**Remaining cases after removing countries with >= 200 cases (Jamaica, Bahamas, Belize)
local remain4 = $m62caricom - $m62_JAM - $m62_BHS - $m62_BLZ
...
** INTRODUCTION
    ...
    putpdf text ("No country recorded had over 500 new cases."),
    putpdf text ("There were an additional 3 countries with over 200 cases: "), linebreak
