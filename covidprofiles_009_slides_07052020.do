** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name					covidprofiles_009_slides_07052020.do
    //  project:				        
...
** SLIDE 3. GROWTH CURVES. 4 CONTROLLED COUNTRIES
** TITLE, ATTRIBUTION, DATE of CREATION
putpdf pagebreak
    putpdf table intro2 = (1,20), width(100%) halign(left)    
    putpdf table intro2(.,.), border(all, nil) valign(center)
...
** FIGURE 
    ...
    putpdf table f2(1,1)=("Barbados"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(2,1)=image("`outputpath'/04_TechDocs/spark_BRB_$S_DATE.png")
    putpdf table f2(1,2)=("Belize"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(2,2)=image("`outputpath'/04_TechDocs/spark_BLZ_$S_DATE.png")
    putpdf table f2(3,1)=("Dominica"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(4,1)=image("`outputpath'/04_TechDocs/spark_DMA_$S_DATE.png")
    putpdf table f2(3,2)=("Trinidad"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(4,2)=image("`outputpath'/04_TechDocs/spark_TTO_$S_DATE.png")


** SLIDE 4. GROWTH CURVES. 4 MOSTLY CONTROLLED COUNTRIES
** TITLE, ATTRIBUTION, DATE of CREATION
putpdf pagebreak
    putpdf table intro2 = (1,20), width(100%) halign(left)    
    putpdf table intro2(.,.), border(all, nil) valign(center)
...
** FIGURE 
    putpdf table f2 = (4,2), width(80%) border(all,nil) halign(center)
    putpdf table f2(1,1)=("The Bahamas"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(2,1)=image("`outputpath'/04_TechDocs/spark_BHS_$S_DATE.png")
    ...
    putpdf table f2(3,1)=("Grenada"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(4,1)=image("`outputpath'/04_TechDocs/spark_GRD_$S_DATE.png")
    putpdf table f2(3,2)=("St Vincent"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(4,2)=image("`outputpath'/04_TechDocs/spark_VCT_$S_DATE.png")


** SLIDE 8. GROWTH CURVES. 3  LESS CONTROLLED COUNTRIES
** TITLE, ATTRIBUTION, DATE of CREATION
putpdf pagebreak
    putpdf table intro2 = (1,20), width(100%) halign(left)    
    putpdf table intro2(.,.), border(all, nil) valign(center)
...
** FIGURE 
    putpdf table f2 = (4,2), width(80%) border(all,nil) halign(center)
    putpdf table f2(1,1)=("Guyana"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(2,1)=image("`outputpath'/04_TechDocs/spark_GUY_$S_DATE.png")
    putpdf table f2(1,2)=("Haiti"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(2,2)=image("`outputpath'/04_TechDocs/spark_HTI_$S_DATE.png")
    putpdf table f2(3,1)=("Jamaica"), halign(left) font("Calibri Light", 20, 0e497c)  
    putpdf table f2(4,1)=image("`outputpath'/04_TechDocs/spark_JAM_$S_DATE.png")
...
putpdf pagebreak
    ...
    putpdf table intro2(1,16), colspan(5)
    putpdf table intro2(1,1)=image("`outputpath'/04_TechDocs/uwi_crest_small.jpg")
    putpdf table intro2(1,2)=("COVID-19 SUMMARY"), halign(left) linebreak
    putpdf table intro2(1,2)=("(Updated on: $S_DATE)"), halign(left) append  font("Calibri Light", 18, 000000)  
    putpdf table intro2(1,16)=("SLIDE 10"), halign(right)  font("Calibri Light", 16, 8c8c8c) linebreak
    
    putpdf table summary = (9,20), width(100%) halign(left)    
    putpdf table summary(.,.), border(all, nil) valign(center)
    putpdf table summary(1,.), font("Calibri Light", 28, 000000)  
    putpdf table summary(2,.), font("Calibri Light", 28, 000000)  
    putpdf table summary(3,.), font("Calibri Light", 28, 000000)  
    putpdf table summary(4,.), font("Calibri Light", 28, 000000)  
    putpdf table summary(5,.), font("Calibri Light", 28, 000000)  
    putpdf table summary(6,.), font("Calibri Light", 28, 000000)  
    putpdf table summary(7,.), font("Calibri Light", 26, 000000)  
    putpdf table summary(8,.), font("Calibri Light", 26, 000000)  
    putpdf table summary(9,.), font("Calibri Light", 26, 000000)  
    putpdf table summary(1,1)
    putpdf table summary(2,2), colspan(19)
    putpdf table summary(3,2), colspan(19)
    putpdf table summary(4,2), colspan(19)
    putpdf table summary(5,2), colspan(19)
    putpdf table summary(6,2), colspan(19)
    putpdf table summary(7,4), colspan(17)
    putpdf table summary(8,4), colspan(17)
    putpdf table summary(9,4), colspan(17)
    putpdf table summary(2,2)=("--> Growth curves and heatmaps great for daily updates")
    putpdf table summary(4,2)=("--> Still based on confirmed cases and confirmed deaths")
    putpdf table summary(6,2)=("--> Now looking at other tools")      
    putpdf table summary(7,4)=("(1) Policy Tracker")      
    putpdf table summary(8,4)=("(2) Movement Data")      
    putpdf table summary(9,4)=("(3) Excess Deaths")      
...
** FIGURE 
    ...
    putpdf table f2(1,1)=image("`outputpath'/04_TechDocs/movement_BRB_$S_DATE.png")
    putpdf table f2(2,1)=image("`outputpath'/04_TechDocs/movement_TTO_$S_DATE.png")
    putpdf table f2(3,1)=image("`outputpath'/04_TechDocs/movement_JAM_$S_DATE.png")



** SLIDE 12. NCD backdrop
putpdf pagebreak
    putpdf table intro2 = (1,20), width(100%) halign(left)    
    putpdf table intro2(.,.), border(all, nil) valign(center)
    putpdf table intro2(1,.), font("Calibri Light", 24, 000000)  
    ...
    putpdf table intro2(1,16), colspan(5)
    putpdf table intro2(1,1)=image("`outputpath'/04_TechDocs/uwi_crest_small.jpg")
    putpdf table intro2(1,2)=("PREMATURE MORTALITY: NCDs"), halign(left) linebreak
    putpdf table intro2(1,2)=("(Updated on: $S_DATE)"), halign(left) append  font("Calibri Light", 18, 000000)  
    putpdf table intro2(1,16)=("SLIDE 12"), halign(right)  font("Calibri Light", 16, 8c8c8c) linebreak
** FIGURE 
    putpdf table f2 = (1,1), width(85%) border(all,nil) halign(left)
    putpdf table f2(1,1)=image("`outputpath'/04_TechDocs/premmort1_$S_DATE.png")
...
** FIGURE 
    putpdf table f2 = (1,1), width(85%) border(all,nil) halign(left)
    putpdf table f2(1,1)=image("`outputpath'/04_TechDocs/premmort2_$S_DATE.png")
...
** FIGURE 
    putpdf table f2 = (1,1), width(85%) border(all,nil) halign(left)
    putpdf table f2(1,1)=image("`outputpath'/04_TechDocs/premmort3_$S_DATE.png")
...
putpdf pagebreak
    ...
    putpdf table intro2(1,16), colspan(5)
    putpdf table intro2(1,1)=image("`outputpath'/04_TechDocs/uwi_crest_small.jpg")
    putpdf table intro2(1,2)=("Many Thanks"), halign(left) linebreak
    putpdf table intro2(1,2)=("(Updated on: $S_DATE)"), halign(left) append  font("Calibri Light", 18, 000000)  
    putpdf table intro2(1,16)=("SLIDE END"), halign(right)  font("Calibri Light", 16, 8c8c8c) linebreak
...
** Save the PDF
    ...
    putpdf save "`outputpath'/05_Outputs/covid19_uwi_slides_`date_string'_cdema", replace
