...
** PAGE 1. TITLE, ATTRIBUTION, DATE of CREATION
    ...
    putpdf table intro2(1,2)=("Map to visualise the location of CARICOM full members and associate members in the Caribbean."), append halign(left) linebreak font("Calibri Light", 13, 000000)
...
** FIGURES - ANTIGUA, BAHAMAS, BARBADOS 
    ...
    putpdf table f2(1,1)=image("`outputpath'/05_Outputs_Papers\01_NPIs_progressreport\Research in Globalization\Re-Submission\background\Caribbean_Map_COVID_19_paper_v4_35percent.jpg")

** Save the PDF
    local c_date = c(current_date)
    local date_string = subinstr("`c_date'", " ", "", .)
    putpdf save "`outputpath'/05_Outputs_Papers\01_NPIs_progressreport\Research in Globalization\Re-Submission\background/supplement3_covid19_map_`date_string'", replace
