** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name				  covidprofiles_002_ecdc_csv_v3.do
    //  project:				        
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\covidprofiles_002_ecdc_csv_v3", replace
** HEADER -----------------------------------------------------
...
** If this does NOT work, we then move to data-source #2 - JOHNS HOPKINS 
