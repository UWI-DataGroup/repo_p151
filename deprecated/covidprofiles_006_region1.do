...
** TABLE PAGE 3: UKOT SUMMARY METRICS
    putpdf table t4 = (8,11), width(100%) halign(center)    
    putpdf table t4(1,.), font("Calibri Light", 9, 000000) border(all, nil) valign(middle) 
    putpdf table t4(2,.), font("Calibri Light", 9, 000000) border(all, nil) bgcolor(e6e6e6) valign(middle)
    ...
    putpdf table t4(8,.), font("Calibri Light", 11, 000000) border(all, nil) valign(middle)
    ...
    putpdf table t4(1,1), font("Calibri Light", 9, 000000) colspan(11) halign(left)
    putpdf table t4(2,1), font("Calibri Light", 10, 000000) bold halign(left)
    putpdf table t4(2,2), font("Calibri Light", 10, 0e497c) bold halign(center)
    putpdf table t4(2,3), font("Calibri Light", 10, 0e497c) bold halign(center)
    putpdf table t4(2,4), font("Calibri Light", 10, 0e497c) bold halign(center)
    putpdf table t4(2,5), font("Calibri Light", 10, 0e497c) bold halign(center)
    putpdf table t4(2,6), font("Calibri Light", 10, 7c0a07) bold halign(center)
    putpdf table t4(2,7), font("Calibri Light", 10, 7c0a07) bold halign(center)
    putpdf table t4(2,8), font("Calibri Light", 10, 7c0a07) bold halign(center)
    putpdf table t4(2,9), font("Calibri Light", 10, 7c0a07) bold halign(center)
    putpdf table t4(2,10), font("Calibri Light", 10, 0e497c) bold halign(center)
    putpdf table t4(2,11), font("Calibri Light", 10, 0e497c) bold halign(center)
    ...
    putpdf table t4(2,1)=("Country"),  halign(left) bgcolor(e6e6e6) 
    putpdf table t4(3,1)=("Anguilla"), bold halign(left)
    putpdf table t4(4,1)=("Bermuda"), bold halign(left)
    putpdf table t4(5,1)=("British Virgin Islands"), bold halign(left)
    putpdf table t4(6,1)=("Cayman Islands"), bold halign(left)
    putpdf table t4(7,1)=("Monserrat"), bold halign(left)
    putpdf table t4(8,1)=("Turks and Caicos Islands"), bold halign(left)

    putpdf table t4(2,2)=("Total cases"),  halign(center) colspan(2) bgcolor(e6e6e6) 
    putpdf table t4(3,2)=image("`outputpath'/04_TechDocs/cases_AIA_$S_DATE.png") , colspan(2)
    putpdf table t4(4,2)=image("`outputpath'/04_TechDocs/cases_BMU_$S_DATE.png") , colspan(2)
    putpdf table t4(5,2)=image("`outputpath'/04_TechDocs/cases_VGB_$S_DATE.png") , colspan(2)
    putpdf table t4(6,2)=image("`outputpath'/04_TechDocs/cases_CYM_$S_DATE.png") , colspan(2)
    putpdf table t4(7,2)=image("`outputpath'/04_TechDocs/cases_MSR_$S_DATE.png") , colspan(2)
    putpdf table t4(8,2)=image("`outputpath'/04_TechDocs/cases_TCA_$S_DATE.png") , colspan(2)

    putpdf table t4(2,4)=("Cases in past week"),  halign(center) bgcolor(e6e6e6) 
    putpdf table t4(3,4)=(${m62_AIA}), halign(center) 
    putpdf table t4(4,4)=(${m62_BMU}), halign(center) 
    putpdf table t4(5,4)=(${m62_VGB}), halign(center) 
    putpdf table t4(6,4)=(${m62_CYM}), halign(center) 
    putpdf table t4(7,4)=(${m62_MSR}), halign(center) 
    putpdf table t4(8,4)=(${m62_TCA}), halign(center) 

    putpdf table t4(2,5)=("Days since 1st case"),  halign(center)  bgcolor(e6e6e6) 
    putpdf table t4(3,5)=(${m05_AIA}), halign(center) 
    putpdf table t4(4,5)=(${m05_BMU}), halign(center) 
    putpdf table t4(5,5)=(${m05_VGB}), halign(center) 
    putpdf table t4(6,5)=(${m05_CYM}), halign(center) 
    putpdf table t4(7,5)=(${m05_MSR}), halign(center) 
    putpdf table t4(8,5)=(${m05_TCA}), halign(center) 

    putpdf table t4(2,6)=("Total deaths"),  halign(center) colspan(2) bgcolor(e6e6e6) 
    putpdf table t4(3,6)=image("`outputpath'/04_TechDocs/deaths_AIA_$S_DATE.png") , colspan(2)
    putpdf table t4(4,6)=image("`outputpath'/04_TechDocs/deaths_BMU_$S_DATE.png") , colspan(2)
    putpdf table t4(5,6)=image("`outputpath'/04_TechDocs/deaths_VGB_$S_DATE.png") , colspan(2)
    putpdf table t4(6,6)=image("`outputpath'/04_TechDocs/deaths_CYM_$S_DATE.png") , colspan(2)
    putpdf table t4(7,6)=image("`outputpath'/04_TechDocs/deaths_MSR_$S_DATE.png") , colspan(2)
    putpdf table t4(8,6)=image("`outputpath'/04_TechDocs/deaths_TCA_$S_DATE.png") , colspan(2)

    putpdf table t4(2,8)=("Deaths in past week"),  halign(center)  bgcolor(e6e6e6) 
    putpdf table t4(3,8)=(${m63_AIA}), halign(center) 
    putpdf table t4(4,8)=(${m63_BMU}), halign(center) 
    putpdf table t4(5,8)=(${m63_VGB}), halign(center) 
    putpdf table t4(6,8)=(${m63_CYM}), halign(center) 
    putpdf table t4(7,8)=(${m63_MSR}), halign(center) 
    putpdf table t4(8,8)=(${m63_TCA}), halign(center) 

    putpdf table t4(2,9)=("Days since 1st death"),  halign(center)  bgcolor(e6e6e6) 
    putpdf table t4(3,9)=(${m06_AIA}), halign(center) 
    putpdf table t4(4,9)=(${m06_BMU}), halign(center) 
    putpdf table t4(5,9)=(${m06_VGB}), halign(center) 
    putpdf table t4(6,9)=(${m06_CYM}), halign(center) 
    putpdf table t4(7,9)=(${m06_MSR}), halign(center) 
    putpdf table t4(8,9)=(${m06_TCA}), halign(center) 

    putpdf table t4(2,10)=("CARICOM growth rates among cases"),  halign(center) colspan(2) bgcolor(e6e6e6) 
    putpdf table t4(3,10)=image("`outputpath'/04_TechDocs/spark_AIA_$S_DATE.png") , colspan(2)
    putpdf table t4(4,10)=image("`outputpath'/04_TechDocs/spark_BMU_$S_DATE.png") , colspan(2)
    putpdf table t4(5,10)=image("`outputpath'/04_TechDocs/spark_VGB_$S_DATE.png") , colspan(2)
    putpdf table t4(6,10)=image("`outputpath'/04_TechDocs/spark_CYM_$S_DATE.png") , colspan(2)
    putpdf table t4(7,10)=image("`outputpath'/04_TechDocs/spark_MSR_$S_DATE.png") , colspan(2)
    putpdf table t4(8,10)=image("`outputpath'/04_TechDocs/spark_TCA_$S_DATE.png") , colspan(2)
