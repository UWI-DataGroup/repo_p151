...
** Temp import for 18-June-2020 - ECDC upload incorrect on this day
** Corrected for Montserrat ISO code
import excel using "`datapath'\version01\1-input\temp_ecdc\COVID-19-geographic-disbtribution-worldwide-2020-06-18_IRHcorrected.xlsx", first clear 
