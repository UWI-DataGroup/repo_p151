** HEADER -----------------------------------------------------
**  DO-FILE METADATA
    //  algorithm name					cdema_simulation_presentation_graphics.do
    ...
    ** Close any open log file and open a new log file
    capture log close
    log using "`logpath'\cdema_simulation_presentation_graphics", replace
** HEADER -----------------------------------------------------
...
** Interventions: Between 90% and 50% transmission reduction  
    ...
    #delimit ;
        gr twoway 
            ...
            ysize(4) xsize(12)
                ...
                text(330 70 "# Acute beds", size(10) place(e) color(gs10))
    ...
    #delimit ;
        gr twoway 
            ...
            ysize(4) xsize(12)
                ...
                ylab(0(100)400
                ,
                labs(10) labc(gs10) notick nogrid glc(gs16) angle(0) format(%9.0f))
                yscale(noline) 
                ytitle("", size(4) margin(l=2 r=2 t=2 b=2)) 
                ///ytick(0(200)400, notick)

                text(100 70 "# ICU beds", size(10) place(e) color(gs10))

                legend(size(10) color(gs10) position(2) ring(0) bm(t=1 b=4 l=5 r=0) colf cols(1)
                region(fcolor(gs16) lw(vthin) margin(l=2 r=2 t=2 b=2)) 
                order(2 3 4) 
                lab(2 "90%") 
                lab(3 "80%") 
                ...
                ;
        #delimit cr
graph export "`outputpath'/04_TechDocs/barbados_criticalcare_presentation.png", replace width(4000)
    ...
    #delimit ;
        gr twoway 
            ...
            ysize(7.5) xsize(10)
                ...
                xlab(0(30)90, labs(4) nogrid glc(gs16))
                ///xscale(off) 
                xscale(fill) 
                xtitle("Days from start of national outbreak", size(4) margin(l=2 r=2 t=2 b=2)) 
                ///xmtick(0(5)85, tl(1))
